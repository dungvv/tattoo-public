...
app.get("/index.2cdaf7bc.css", function (req, res) {
  res.sendFile(__dirname + "/index.2cdaf7bc.css");
});

app.get("/index.975ef6c8.js", function (req, res) {
  res.sendFile(__dirname + "/index.975ef6c8.js");
});
